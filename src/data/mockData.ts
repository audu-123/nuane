...
export const mockFeedback = {
  pass: {
    internal: `候选人李明本次二面整体表现优秀，综合评分位于团队历次面试前20%区间。\n\n具体来看，候选人的 React 基础非常扎实，能够清晰阐述 Fiber 架构与并发模式的设计原理，并结合实际项目经验给出有深度的见解。TypeScript 工程化实践超出预期，对泛型约束、条件类型等高级特性应用自如，显示出扎实的工程素养。\n\n组件设计方面，候选人展示了较强的抽象能力，能从可复用性、可维护性角度出发设计组件边界，思路清晰。\n\n建议进入三面，重点考察系统架构设计与跨团队协作能力。`,
    external: `## 🎉 恭喜您顺利通过本轮面试！\n\n以下是您进入下一轮的专属通关锦囊：\n\n### 📌 下一轮考察侧重点\n\n三面将重点考察以下方向，建议提前准备：\n- **系统架构设计**：大规模前端应用的架构决策与演进思路\n- **跨团队协作**：如何推动技术标准落地、与产品/后端高效协作\n- **技术影响力**：您在团队中推动过哪些技术改进或基建建设\n\n### 💡 本轮低分维度改进建议\n\n组件设计方面可进一步深化：在设计组件时，不妨思考如何平衡灵活性与简洁性，推荐研究 Headless UI 设计模式。\n\n### 📚 推荐阅读资料\n\n- [React 官方文档 - 深入架构理解](https://react.dev/learn)\n- [TypeScript Deep Dive（中文版）](https://jkchao.github.io/typescript-book-chinese/)\n- [前端工程化最佳实践](https://github.com/tencent/feflow)`,
  },
  fail: {
    internal: `候选人李明本次二面综合评估未达到岗位要求，主要短板集中在基础算法与系统设计层面。\n\n算法 能力 比较生疏，面试过程中在 LRU Cache 设计题上思路混乱，未能在有限时间内给出可行方案，考虑到该岗位对性能优化有较高要求，此项为关键扣分点。\n\n系统设计 方面 略低预期，对于高并发场景下的前端渲染优化策略缺乏系统性思考，回答较为碎片化。\n\nReact 基础尚可，但 深度不足，对 Concurrent Mode 的理解停留在概念层面，无实际应用经验。\n\n综合以上，建议本轮不予通过，可在候选人算法基础与项目经验充实后再次邀约。`,
    external: `## 感谢您参与本次面试 💪\n\n我们非常欣赏您在面试中展现出的积极态度与学习潜力。以下是我们为您精心准备的成长建议书：\n\n### ✨ 您的亮点\n\n- React 基础理解 令人印象深刻，您对组件生命周期和状态管理的理解思路清晰\n- 面试过程中展现出良好的 沟通能力，表达流畅，逻辑 条理清晰\n- 对新技术保持积极的探索精神，这是优秀工程师最重要的特质之一\n\n### 🌱 成长建议\n\n**算法** 方面：不需要焦虑，算法是可以通过系统训练显著提升的技能。建议每天坚持 1-2 道 LeetCode 练习，从数组、链表等基础数据结构入手，循序渐进。\n\n**系统设计** 方面：可以尝试从实际项目出发，思考"如果流量增长10倍，当前方案会在哪里遇到瓶颈"，这是培养系统设计思维的有效方法。\n\n### 📚 学习资源推荐`,
  },
  passFinal: {
    internal: `候选人李明本次终面整体表现优秀，综合评估符合录用标准。\n\n具体来看，候选人的技术深度与广度兼备，系统架构设计与跨团队协作能力均达到预期。能够结合实际业务场景给出合理的架构决策，并对未来演进有清晰的规划。\n\n建议录用，并安排后续的入职沟通。`,
    external: `## 🎉 恭喜您顺利通过终面！\n\n我们非常高兴地通知您，您已通过本次面试的所有考核环节。以下是为您准备的专属入职建议书：\n\n### 📌 入职前准备建议\n\n为了帮助您更好地融入团队，建议您在入职前可以提前了解以下方向：\n- **业务背景**：了解相关行业动态与竞品情况，思考技术如何更好地赋能业务\n- **技术栈熟悉**：重温或拓展与团队紧密相关的技术领域（如微前端架构、性能监控等）\n- **团队协作规范**：思考如何在新团队中快速建立信任，并推动技术标准落地\n\n### 💡 您的突出优势\n\n您的架构设计思维与解决复杂问题的能力让我们印象深刻，期待您在未来的工作中继续发挥这些优势，为团队带来更多的技术突破。\n\n### 📚 推荐阅读资料\n\n- [深入理解软件架构设计](https://github.com/)\n- [高效研发团队的协作实践](https://github.com/)\n\n期待与您共事！`,
  },
};
